...
import { User, Mail, Phone, MapPin, LogOut, Settings, ShieldCheck, AlertTriangle, Loader2, Save, Users, Search } from "lucide-react"
  ...
  return (
    <div className="space-y-6 sm:space-y-8 pb-20">
      ...
      <div className="flex items-center justify-between gap-4">
        <h2 className="text-2xl sm:text-3xl font-bold text-slate-900">Profil Saya</h2>
